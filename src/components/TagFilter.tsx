...
export const TagFilter = forwardRef<HTMLSelectElement, TagFilterProps>(
  function TagFilter({ tags, selectedTag, onTagSelect }, ref) {
    ...
    return (
      <div className="flex items-center">
        ...
        >
          <span className="underline">t</span>ag
        </label>
        <select
          ref={ref}
          value={selectedTag}
